...
class CreateMQO:
    ...
    #
    def __init__(self, texture, use_cut, mouth_shape, data_folda):
        ...
        # ファイル出力
        self.model_filename = "{}/{}/{}_{}.mqo".format(self.data_folda, mouth_shape, self.today, mouth_shape)
        if self.use_cut:
            self.model_filename = "{}/{}/cut_{}_{}.mqo".format(self.data_folda, mouth_shape, self.today, mouth_shape)
    ...
    def set_point(self, texture_filename):
        ...
        # テクスチャファイル読み込み
        img = cv2.imread(self.data_folda+'/'+texture_filename)
...
if __name__ == '__main__':
    ...
    CreateMQO(sys.argv[1], sys.argv[2], sys.argv[3])
